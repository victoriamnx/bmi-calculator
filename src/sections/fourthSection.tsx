...
import IconGender from "../components/images/icon-gender.svg";
import IconAge from "../components/images/icon-age.svg";
import IconMuscle from "../components/images/icon-muscle.svg";
import IconPregnancy from "../components/images/icon-pregnancy.svg";
import IconRace from "../components/images/icon-race.svg";
